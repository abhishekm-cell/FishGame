...
public class Obstacle : MonoBehaviour
{
    ...
    // Set by SpawnSystem at spawn time, scales bob frequency + horizontal speed
    private float difficultyMultiplier = 1f;
 
    private Vector2 startPos; 
    public void Init(ObstacleData data, GameManager gameManager, float difficultyMultiplier = 1f)
    {
        obsdata = data;
    ...
    void Start()
    {
        ...
        frequency =  UnityEngine.Random.Range(obsdata.minFrequency, obsdata.maxFrequency) * difficultyMultiplier;
    ...
    {
        transform.Translate(Vector3.left * UnityEngine.Random.Range(moveSpeed, obsdata.horiSpeed) * difficultyMultiplier * Time.deltaTime);
    }
