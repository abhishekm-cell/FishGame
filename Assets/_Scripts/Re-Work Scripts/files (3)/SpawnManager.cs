...
public class SpawnManager : MonoBehaviour
{
    ...
    private void SpawnFishOnLane(LaneConfigSO.Lane lane, int laneIndex)
    {
        ...
        var obj = _pool.GetFish(sizeValue);
    ...
    {
        var fishLanes = System.Array.FindAll(laneConfig.lanes, l => l.type == LaneConfigSO.LaneType.FishLeft || l.type == LaneConfigSO.LaneType.FishRight);
